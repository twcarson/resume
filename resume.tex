...
\begin{itemize} \itemsep 0pt
	\item create experimental and production acoustic models in several languages
	\item coordinate presentations and meetings for a team of engineers and linguists
	\item port legacy repository from C to Python
\end{itemize}
\textit{English Data Specialist} \hfill Mar 2020 - Aug 2021\\
\vspace{-3mm}
\begin{itemize} \itemsep 0pt
	\item debug issues in language and acoustic models
	\item train acoustic models
	\item develop and iterate on web tool for audio data collection
\end{itemize}
\textit{English Data Intern} \hfill Aug 2019 - Mar 2020\\
\vspace{-3mm}
\begin{itemize} \itemsep 0pt
	\item designed and maintained sql database
	\item created a collection of text data conditioning tools
\end{itemize}
\vspace{1mm}
